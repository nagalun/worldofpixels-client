...
OPT_DBG  = -g4 -s ASSERTIONS=2 -s STACK_OVERFLOW_CHECK=2 -s DEMANGLE_SUPPORT=1 -s SAFE_HEAP=1
...
# GLM config
CPPFLAGS += -D GLM_FORCE_ARCH_UNKNOWN -D GLM_FORCE_CXX17
CPPFLAGS += -I ./lib/glm/

LDFLAGS  += -s FILESYSTEM=0 -s ENVIRONMENT=web #-s WEBGL2_BACKWARDS_COMPATIBILITY_EMULATION=1
